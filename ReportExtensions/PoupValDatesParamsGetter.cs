...
{
    [Export("ReportExtensions.PoupValDatesParamsGetter", typeof(IReportParametersGetter))]
    [PartCreationPolicy(CreationPolicy.NonShared)]
    public class PoupValDatesParamsGetter : BaseReportParametersGetter
    {
        ...
        public override BaseDlgViewModel GetDialog(ReportModel _repInfo, Action _onSubmit)
        {
            ...
            var dialog = new PoupValDatesDlgViewModel(repository, issavedate)
            {
        ...
        private void Init(PoupValDatesDlgViewModel _dialog, System.Collections.Generic.Dictionary<string, string> _params)
        {
        ...
        {
            var dlg = _dlg as PoupValDatesDlgViewModel;
            if (dlg == null) return;
